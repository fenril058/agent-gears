...
#
# 由来: https://github.com/yasunori0418/skills (nix/skills-ref.nix, MIT)。
# その derivation をほぼそのまま取り込んだもの。skills-ref 本体は agentskills/agentskills
# の subdirectory(Apache-2.0)。
#
