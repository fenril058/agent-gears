...
| `rules.enable` | `true` | `rules/always-on.md` を `CLAUDE.md` / `AGENTS.md` / `copilot-instructions.md` として配布 |
...
| 対象 | Claude Code | Codex | GitHub Copilot | 共有ストア |
|------|-------------|-------|----------------|-----------|
| 各 skill | `~/.claude/skills/` | `~/.codex/skills/` | `~/.copilot/skills/` | `~/.agents/skills/` |
...
- **常時ルール**: Claude は `CLAUDE.md`、Codex は `AGENTS.md`、Copilot は `copilot-instructions.md` を読む。いずれも配布元は `rules/always-on.md`。
